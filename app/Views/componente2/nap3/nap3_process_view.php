<main class="container px-2">
    <div class="container-fluid px-0">
        <h3 class="mt-4"><?= esc($title).' - NAP 3 DOCENTES DYA'; ?></h3>
        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                <a type="button" id="btn-register" href="<?= site_url().'nap3-create/'; ?>" class="edit">
                    <img src="<?= site_url().'public/images/new.png'; ?>" >
                    <span id="title-link">Registrar un nuevo docente</span>
                </a>
                <?php
                    if ($this->session->descargar_info == 1) {
                        echo'<a href="'.site_url().'nap3-descargar-registros" class="btn btn-info mb-2" id="btn-descarga-registros">Descargar registros NAP 3 (.xlsx)</a>';
                    }
                ?>
            </div> 
            <div class="card-body"> 

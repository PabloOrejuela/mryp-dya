<main class="container px-2">
    <div class="container-fluid px-0">
        <h3 class="mt-4"><?= esc($title).' - NAP 6 Estudiantes MINEDUC Virtual'; ?></h3>
        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                <a type="button" id="btn-register" href="<?= site_url().'nap6-create/'; ?>" class="edit">
                ...
                <?php
                    if ($this->session->descargar_info == 1) {
                        echo'<a href="'.site_url().'nap6-descargar-registros" class="btn btn-info" id="btn-descarga-registros">Descargar registros NAP 6 (.xlsx)</a>';
                    }
                ?>
            </div> 
            <div class="card-body"> 

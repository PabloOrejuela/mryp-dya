<main class="container px-2">
    <div class="container-fluid px-0">
        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                <a type="button" id="btn-register" href="<?= site_url().'nap2-create/'; ?>" class="edit">
                    ...
                    <?php
                        if (isset($nap2) && $nap2 != NULL) {
                            foreach ($nap2 as $key => $value) {
                                echo '<tr>
                                        <td>'.$value->id.'</td>
                                        <td><a href="'.site_url().'prod2-nap2-frm-edit/'.$value->id.'">'.strtoupper($value->nombres.' '.$value->apellidos).'</a></td>
                                        <td>'.$value->amie.'</td>
                                        <td>'.$value->nombre.'</td>
                                        <td>'.$value->regimen.'</td>

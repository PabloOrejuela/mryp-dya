                    ...
                    <div class="col-sm-6">
                        ...
                        <?php
                            if ($datos != NULL) {
                                ...
                                echo '<option value="0" selected>Registrar dato</option>
                    ...
                    <div class="col-sm-6">
                        <?php
                            if (isset($datos_diag_myrp->observacion) && $datos_diag_myrp->observacion != null && $datos_diag_myrp->observacion != '') {
                                echo '<textarea name="" id="" cols="30" rows="3">'.$datos_diag_myrp->observacion.'</textarea>';
                            }else{
                                echo '<textarea name="" id="" cols="30" rows="3"></textarea>';
                            }
                        ?>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                        <?php
                            if (isset($datos_diag_myrp->p2_descripcion_dibujo) && $datos_diag_myrp->p2_descripcion_dibujo != null && $datos_diag_myrp->p2_descripcion_dibujo != '') {
                                echo '<textarea name="" id="" cols="30" rows="3">'.$datos_diag_myrp->p2_descripcion_dibujo.'</textarea>';
                            }else{
                                echo '<textarea name="" id="" cols="30" rows="3"></textarea>';
                            }
                        ?>

    ...
    <div class="container-fluid px-0">
        ...
        <form action="<?php echo base_url().'/prod1-diagnostico-update';?>" method="post">
            ...
            <div class="card mb-4">
                ...
                <div class="col-md-4 mb-2">
                        <label for="anio_egb">Grado de EGB (Obligatorio):</label>
                            <div class="col-sm-6">
                                <select 
                                    class="form-select" 
                                    aria-label="Default select example" 
                                ...
                                <?php
                                    ...
                                    if ($prod != NULL) {
                                        if ($prod->anio_egb != '' && isset($prod->anio_egb) && $prod->anio_egb != ' ') {
                                            foreach ($cursos as $key => $c) {
                                                if ($prod->anio_egb == $c->id) {
                                                    echo '<option value="'.$c->id.'" selected>'.$c->curso.' EGB</option>';
                                                }else{
                                                    echo '<option value="'.$c->id.'">'.$c->curso.' EGB</option>';
                                                }
                                            }
                                        }else{
                                            echo '<option value="NULL" selected>Registrar dato</option>';

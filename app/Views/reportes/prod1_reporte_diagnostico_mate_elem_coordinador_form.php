<main class="container">
    <div class="container-fluid px-4">
        <h3 class="mt-4"><?= esc($title).' - REPORTE DE MATEMÁTICAS (PRUEBA ELEMENTAL) POR PROVINCIA'; ?></h3>
        <div class="card mb-6">
            <div class="card-body" id="card-reportes">
                <form action="<?php echo base_url().'/recibe-diagnostico-matelement-coordinador';?>" method="post">

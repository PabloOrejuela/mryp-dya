    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <?= esc("Reporte de Destrezas"); ?>
            </div>
            <div class="card-body" id="card-reportes"> 
                <form action="<?php echo base_url().'/recibe-reporte-destrezas-p1-tab';?>" method="post" id="form">
                        ...
                        if ($reporte == '1') {
                            echo '
                                <div class="form-check">
                                    <input class="form-radio-input" type="radio" value="1" name="reporte" id="flexRadioDefault" checked>
                                    <label class="form-radio-label" for="flexRadioDefault">Destrezas muy por debajo de lo esperado</label>
                                    
                                </div>
                                <div class="form-check">
                                    <input class="form-radio-input" type="radio" value="2" name="reporte" id="flexRadioDefault">
                                    <label class="form-radio-label" for="flexRadioDefault">Destrezas en proceso</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-radio-input" type="radio" value="2" name="reporte" id="flexRadioDefault">
                                    <label class="form-radio-label" for="flexRadioDefault">Destrezas adecuadas</label>
                                </div>
                            ';
                            ...
                            echo '
                                <div class="form-check">
                                    <input class="form-radio-input" type="radio" value="1" name="reporte" id="flexRadioDefault">
                                    <label class="form-radio-label" for="flexRadioDefault">Destrezas muy por debajo de lo esperado</label>
                                    
                                </div>
                                <div class="form-check">
                                    <input class="form-radio-input" type="radio" value="2" name="reporte" id="flexRadioDefault" checked>
                                    <label class="form-radio-label" for="flexRadioDefault">Destrezas en proceso</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-radio-input" type="radio" value="2" name="reporte" id="flexRadioDefault">

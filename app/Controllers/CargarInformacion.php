            ...
            if ($file->hasMoved()) {
                ...
                foreach ($sheet->getRowIterator(3) as $row) {
                    ...
                    $prod4 = array(
                        ...
                        'nombres' => strtoupper(trim($sheet->getCell('F'.$row->getRowIndex()))).' '.strtoupper(trim($sheet->getCell('G'.$row->getRowIndex()))),
                        'documento' => trim($sheet->getCell('H'.$row->getRowIndex())),
                        'nacionalidad' => strtoupper(trim($sheet->getCell('I'.$row->getRowIndex()))),  
                        'fecha_nac' => date("Y-m-d", strtotime(trim($sheet->getCell('J'.$row->getRowIndex())))),
                        'edad' => trim($sheet->getCell('K'.$row->getRowIndex())),
                        'discapacidad' => trim($sheet->getCell('L'.$row->getRowIndex())),    
                        'tipo_discapacidad' => trim($sheet->getCell('M'.$row->getRowIndex())),
                        'genero' => strtoupper(trim($sheet->getCell('N'.$row->getRowIndex()))),
                        'barrio' => trim($sheet->getCell('O'.$row->getRowIndex())),
                        'contacto_telf' => trim($sheet->getCell('P'.$row->getRowIndex())),
                        'email' => trim($sheet->getCell('Q'.$row->getRowIndex())),
                        'num_hijos' => trim($sheet->getCell('R'.$row->getRowIndex())),
                        'edad_hijo_1' => trim($sheet->getCell('S'.$row->getRowIndex())),
                        'edad_hijo_2' => trim($sheet->getCell('T'.$row->getRowIndex())),
                        'edad_hijo_3' => trim($sheet->getCell('U'.$row->getRowIndex())),
                        'estudia' => trim($sheet->getCell('V'.$row->getRowIndex())),
                        'tiempo_sin_estudiar' => trim($sheet->getCell('W'.$row->getRowIndex())),
                        'institucion' => strtoupper(trim($sheet->getCell('X'.$row->getRowIndex()))),
                        'anio_egb' => trim($sheet->getCell('Y'.$row->getRowIndex())),
                        'embarazada' => trim($sheet->getCell('Z'.$row->getRowIndex())),
                        'semanas' => trim($sheet->getCell('AA'.$row->getRowIndex())),
                        'controles' => trim($sheet->getCell('AB'.$row->getRowIndex())),
                     );
